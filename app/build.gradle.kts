...
android {
    ...
    defaultConfig {
        applicationId = "com.keys.Stellarysian"
...
registerDownloadTask(
    ...
    srcUrl = "https://github.com/Stellarysian/KernelPatch/releases/download/$kernelPatchVersion/kpimg-android",
...
registerDownloadTask(
    ...
    srcUrl = "https://github.com/Stellarysian/KernelPatch/releases/download/$kernelPatchVersion/kptools-android",
